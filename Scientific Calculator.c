...
int main(){
	...
	if(init.op[0] == 'B'||init.op[0] == 'b'){//Transfers to Basic Operations Mode
		printf("-=BASIC MODE=-\nAvailable Operators:\n1. Addition (+)\n2. Subtraction(-)\n3. Multiplication(x)\n4. Division(/)\n5. Power(^)\n6. Roots(R)\n7. Factorial(!)\n\nInput Example: 2x3+25/2+3! or 3!2+10/5-8\n(note: do not use parentheses(). For factorials in the middle of 2 operators\ndisregard the operator and input it like the example shown. An option to input\nyour operator will show up after you hit enter.)\n\nEnter \"0B\" to return to main menu.\n\nEnter Calculations ");
